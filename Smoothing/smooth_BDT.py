...
if __name__ == '__main__':
 ...
 parser.add_argument('-oP', '--oP', dest='oP', required=False, type=str)
 ...
 compareHistos(h_bdt_data_SB_diffBins,h_bdt_datamix_SB_diffBins,outputPlot+"/h_bdt_SB_m"+str(mass),1)
 ...
 compareHistos(h_bdt_data_SB_diffBins,h_bdt_datamix_SB_weighted_diffBins,outputPlot+"/h_bdt_SB_weighted_m"+str(mass),1)
 ...
 for algo in algos:
   ...
   if hist_smooth!=-1:
     drawHistos(h_bdt_datamix_SR_weighted,hist_smooth[0],hist_smooth[1],hist_smooth[2],str(outputPlot)+"/"+h_bdt_datamix_SR_weighted.GetName()+"_smoothing_"+algo+"_m"+str(mass))
     drawHisto(hist_smooth[4],str(outputPlot)+"/"+h_bdt_datamix_SR_weighted.GetName()+"_smoothing_"+algo+"_Diff_m"+str(mass))
   ...
   if hist_smooth!=-1:
     drawHistos(h_bdt_datamix_SB_weighted,hist_smooth[0],hist_smooth[1],hist_smooth[2],str(outputPlot)+"/"+h_bdt_datamix_SB_weighted.GetName()+"_smoothing_"+algo+"_m"+str(mass))
     drawHisto(hist_smooth[4],str(outputPlot)+"/"+h_bdt_datamix_SB_weighted.GetName()+"_smoothing_"+algo+"_Diff_m"+str(mass))
   ...
   if hist_smooth!=-1:
     drawHistos(h_bdt_data_SB,hist_smooth[0],hist_smooth[1],hist_smooth[2],str(outputPlot)+"/"+h_bdt_data_SB.GetName()+"_smoothing_"+algo+"_m"+str(mass))
     drawHisto(hist_smooth[4],str(outputPlot)+"/"+h_bdt_data_SB.GetName()+"_smoothing_"+algo+"_Diff_m"+str(mass))
     h_bdt_data_SB.Write()
     hist_smooth[0].Write()
     hist_smooth[1].Write()
     hist_smooth[2].Write()
